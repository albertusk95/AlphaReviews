angular.module('writeareview', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
	$routeProvider.when('/writeareview', {
		templateUrl: '../public/writeareview/writeareview.jsp',
		controller: 'writeareview_Ctrl'
	});
}])

.controller('writeareview_Ctrl', ['$scope', function($scope) {
	
	console.log("writeareview controller...");
